###########################################################################
## Makefile generated for component 'Yaw1'. 
## 
## Makefile     : Yaw1.mk
## Generated on : Tue Feb 27 21:58:37 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Yaw1.elf
...
PRODUCT_NAME              = Yaw1
MAKEFILE                  = Yaw1.mk
MATLAB_ROOT               = E:/Program Files/MATLAB/R2023b
MATLAB_BIN                = E:/Program Files/MATLAB/R2023b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = E:/0000KSHI/MATLAB/simulink/PID_3508_MATLAB-master0.2/PID_MODEL
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
COMPILER_COMMAND_FILE     = Yaw1_comp.rsp
CMD_FILE                  = Yaw1.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Yaw1.elf
...
DEFINES_STANDARD = -DMODEL=Yaw1 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/Yaw1_ert_rtw/Yaw1.c $(START_DIR)/Yaw1_ert_rtw/Yaw1_data.c
...
%.o : $(START_DIR)/Yaw1_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Yaw1_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Yaw1_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Yaw1_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Yaw1.o : $(START_DIR)/Yaw1_ert_rtw/Yaw1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Yaw1_data.o : $(START_DIR)/Yaw1_ert_rtw/Yaw1_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
